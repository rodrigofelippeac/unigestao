# `.memory/rules/frontend/` — conhecimento do projeto para a persona global `frontend`

A persona **`frontend`** é global (`~/.claude/agents/frontend.md`): traz o *comportamento*. O *conhecimento
