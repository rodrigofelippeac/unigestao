# `.memory/rules/devops/` — conhecimento do projeto para a persona global `devops`

A persona **`devops`** é global (`~/.claude/agents/devops.md`): traz o *comportamento*. O *conhecimento
